...
void CommandLineReporter::indexing_status(const string &index_filename,
                                          ...
                                          IndexUpdateCheck status)
{
    ...
    switch (status) {
      ...
      case IndexUpdateCheck::TooOld:
        clog << "index file " << index_filename
             << " is older than trace file " << trace_filename
             << "; rebuilding it" << endl;
        break;
      ...
      case IndexUpdateCheck::Incomplete:
        clog << "previous generation of index file " << index_filename
