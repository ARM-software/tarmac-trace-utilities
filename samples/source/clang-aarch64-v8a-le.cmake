...
# build the example images for 64-bit little-endian Arm v8-A using
# clang.
...
string(APPEND CMAKE_C_FLAGS " --target=aarch64-arm-none-eabi -march=armv8-a -fno-exceptions ")
string(APPEND CMAKE_CXX_FLAGS " --target=aarch64-arm-none-eabi -march=armv8-a -fno-exceptions ")
string(APPEND CMAKE_ASM_FLAGS " --target=aarch64-arm-none-eabi -march=armv8-a ")
